...
const SEGMENTS: TimeSettingsSegment[] = [
  ...
  { label: "늦조 출근 시작",   key: "lateCheckInWindow"  as const, field: "start" as const },
  { label: "늦조 출근 종료",   key: "lateCheckInWindow"  as const, field: "end"   as const },
  { label: "늦조 퇴근 시작",   key: "lateCheckOutWindow" as const, field: "start" as const },
